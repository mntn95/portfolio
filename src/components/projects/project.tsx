    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="absolute top-0 w-full h-full flex flex-col items-center justify-center grap-y-2 bg-white/95 p-6 rounded-lg dark:bg-zinc-700/95 transition-colors"
            >
