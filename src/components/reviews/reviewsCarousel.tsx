...
const ReviewsCarousel: React.FC<ReviewsCarouselT> = ({ index, direction }) => {
    ...
    return (
        <motion.div
            ...
            className="relative w-[800px] lg:w-[580px] md:w-[95%] sm:w-[300px] h-[400px] lg:h-[600px] md:h-[600px] sm:h-[600px] flex items-center justify-center overflow-hidden hover:drop-shadow-[0px_0px_3px_var(--color-border)]"
        >
